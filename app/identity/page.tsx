...
const INTELLECT: StatTableData = {
  ...
  groups: [
    ...
    },
    {
      ...
      rows: [
        {
          category: "Philosophy (reasoning)",
          metrics: [
            ["Integrated position", "integral rational optimist (physical · agentic-optimist)", false],
            ["Epistemology", "critical rationalist", true],
            ["Metaphysics", "physical idealist", true],
            ["Cosmology", "evolutionary emergentist", true],
            ["Teleology", "self-authored", true],
            ["Theology", "agnostic atheist", true],
            ["Anthropology", "universalist", true],
            ["Axiology", "amoral realist", true],
          ],
        },
      ],
    },
