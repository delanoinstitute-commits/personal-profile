      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["2020–2021 (ages 33–34)", ["Places (Seattle, Costa Rica, then home days before the lockdown; Camps Bay from March 2021); events (codified the 10X method and published it free; the ", <WikiLink key="quest" href="https://www.mindvalley.com/10x/quest">10X Quest</WikiLink>, " launched, since completed by over 90,000 people); activities (certified in nutritional biochemistry, then blood chemistry analysis)"], true],
