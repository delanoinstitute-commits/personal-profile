      ...
      rows: [
        {
          ...
          metrics: [
            ["", "Income I must show up for, priced by the hour or by the sale", false],
            ["Service", "Hourly rate ($500)", true, "Time exchanged directly for money. The rate is the single lever: it prices every engagement, whether billed as professional fees, salary, or wage."],
            ...
            ["Product", "Sales margin — higher is better", true, "Things sold rather than hours billed; margin is the fraction of each sale kept after its costs."],
        ...
        },
        {
          ...
          metrics: [
            ["", "Income my assets earn whether I show up or not", false],
            ["Partnership", "Percentage share — higher is better", true, "Income from association rather than labour or capital: a share of someone else's sales or audience."],
            ...
            ["Investment", "Return ratio >1.0 against benchmark", true, "What owned capital pays out, measured against the index alternative — a ratio under 1.0 means the passive index would have done better."],
            ...
            ["Gifts", "Share of income — lower is better", true, "Unearned inflows. Welcome, never planned on — a rising share signals dependence rather than fortune."],
            ["Bonuses", "Discretionary awards", true, undefined, undefined, true],
            ["Grants", "Institutional awards", true, undefined, undefined, true],
