      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Mobility", "Transit (rideshare; public transit) and vehicle (lease; fuel; charging)", true, "Industrials and Energy — the sector that completes the set: with Mobility, the expense map touches all eleven GICS sectors.", undefined, true],
            ...
            ["Personal", "Experiences (dining; entertainment; education) and goods (software subscriptions)", true, "Consumer Discretionary and Information Technology.", undefined, true],
          ],
        },
        {
