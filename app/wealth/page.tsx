      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Interest", "Blended cost of debt <5% APR", true, "The weighted average rate across everything owed, kept below what invested capital conservatively returns so debt never outruns assets. Cards and worthiness loans are unsecured — priced on faith; the rest is secured on the asset it bought."],
            ["Credit cards", "Paid in full monthly — 0% effective", true, undefined, undefined, true],
            ["Worthiness", "Unsecured personal, student, and business loans — taken on faith; none held", true, undefined, undefined, true],
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Dividends", "Payout margin ≤15% — the lifestyle draw and the giving", true, "What profit becomes consumption and contribution — experiences, goods, and donations. Capped so lifestyle never grows as fast as income."],
