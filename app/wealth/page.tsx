      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Rentals", "Income property through Erfaring (Pty) Ltd", true, "Erfaring (Pty) Ltd — the real-estate venture registered 24 October 2024, holding title where deals justify custody.", undefined, true],
            ["Preservation", "Pending (a hedge, not a bet)", true, "The store of value against debasement — sized as insurance rather than conviction. The benchmark waits on the first position."],
