      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Ownership", "Effective rate <2% (assets held)", true, "Taxes on simply holding an asset, year after year — in the US, essentially property tax; a renter pays it invisibly inside rent."],
            ["Property", "Local rates on real estate held", true, undefined, undefined, true],
            ["Transfer", "Effective rate <15% (assets transferred)", true, "Taxes triggered by moving an asset: selling it (capital gains), giving it (gift), or leaving it (estate). Long-term rates only — a hold under a year invites ordinary rates instead."],
