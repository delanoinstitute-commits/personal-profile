      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Psychologist (AI)", "Private; Claude (sounding board)", true, "The best psychologists treat below health and refer beyond it — therapy as treatment is nurture; as development it sits under Growth, with the practitioners. The sounding board supplements, never substitutes.", undefined, true],
