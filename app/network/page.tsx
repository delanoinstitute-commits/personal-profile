      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Neighbors", "Private", true, "The best neighbors are close, warm, and watchful. One of the map’s five connectors — the local world’s map of who shows up and who to trust.", undefined, true],
          ],
        },
      ],
    },
      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Fiduciary", "Pending", true, "The best fiduciaries are fee-only, capable, and conflict-free. The episodic experts — attorneys, brokers, agents — are reached through this tier’s advocacy, not kept on retainer. One of the map’s five connectors — the money world behind one fee-only relationship.", undefined, true],
          ],
        },
      ],
    },
      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Members", "Abundance360; Integral Life", true, "The peers of chosen rooms — masterminds, clubs, cohorts — joined on purpose and sworn to candor. One of the map’s five connectors — every member a gateway to their own cluster.", undefined, true],
