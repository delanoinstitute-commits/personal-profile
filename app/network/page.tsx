      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Fiduciary (connector)", "Pending", true, "The best fiduciaries are fee-only, capable, and conflict-free. The episodic experts — attorneys, brokers, agents — are reached through this tier’s advocacy, not kept on retainer. One of the map’s five connectors — the money world behind one fee-only relationship.", undefined, true],
          ],
        },
      ],
    },
      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Counterparties (revenue)", "The best counterparties bring capital, distribution, and incentives", true],
      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Clients (referrers)", "Pending", true, "The patron at arm’s length: they buy outcomes, and the rate prices the value rather than the time — and the best bring the next client with them.", undefined, true],
