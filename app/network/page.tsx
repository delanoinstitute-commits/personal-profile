      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Groomers", "Consistent and likable", true, "The body's attendants — hair, nails, skin. Seen often enough that likability matters: a groomer kept for years knows the head they are working on."],
