      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Fiduciary", "Pending", true, "The best fiduciaries are fee-only, capable, and conflict-free. The episodic experts — attorneys, brokers, agents — are reached through this tier’s advocacy, not kept on retainer.", undefined, true],
          ],
        },
      ],
    },
      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Mentors", "The best mentors are a decade ahead and still ask more than they tell", true],
            ["Masterminds", "The best masterminds are small, candid, and slightly out of your league", true],
            ["Language partner", "The best language partners trade tongues evenly and correct in the moment", true],
          ],
        },
        {
          ...
          metrics: [
            ...
            ["Coach", "The best coaches see what I cannot and say it before I want to hear it", true],
            ["Trainer", "The best trainers program for the decade, not the session", true],
            ["Therapist", "The best therapists ask the question I have been avoiding", true],
          ],
        },
        {
          ...
          metrics: [
            ...
            ["Cofounders", "The best cofounders are opposite in skill, identical in values", true],
            ["Investors", "The best investors bring the network and the patience, not just the check", true],
            ["Managers", "The best managers need the goal, not the method", true],
            ["Affiliates", "The best affiliates sell what they already use", true],
          ],
        },
      ],
    },
