      ...
      rows: [
        {
          ...
          metrics: [
            ["", "One specialization, one mission, both tested on myself first", false],
            [
              "Specialization",
              "Applied taxonomist focused on personal transformation",
              true,
            ...
            ["Taxonomist", "Modeling what is, what could be, and the transformations that close the gap (this site holds 20+ taxonomies)", true, undefined, undefined, true],
            ["Applied", "Testing every model against reality, and revising until it produces the outcome", true, undefined, undefined, true],
            ["Transformation", "The behavioral changes (cognitive, physiological, psychosocial, and environmental) that grow a person’s capital (health, knowledge, wealth, and network)", true, undefined, undefined, true],
            [
              "Mission",
              "Accumulate and allocate my life capital where it benefits others most",
              true,
            ],
            ["Self", "Solve my own problems first, then publish the solutions free for anyone", true, undefined, undefined, true],
            ["Individuals", "Help others apply the same solutions to their lives, partners, and families, for a fee", true, undefined, undefined, true],
            ["Companies", "Help companies build the same solutions into products for their employees and customers, for a fee", true, undefined, undefined, true],
          ],
        },
        {
