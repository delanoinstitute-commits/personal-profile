      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Resources (6)", [
              ...
              " (laptop; phone; wearables), monitors (ring; cuff), documents, and everyday-carry (",
              <WikiLink key="wal" href="https://ridge.com/">wallet</WikiLink>,
              "; ",
              <WikiLink key="key" href="https://www.orbitkey.com/">keys</WikiLink>,
              "; power bank; ",
              <WikiLink key="bag" href="https://bellroy.com/">bag</WikiLink>,
              ")",
            ], true],
