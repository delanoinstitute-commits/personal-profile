      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Spaces (6)", "Bedroom (bed; storage), bathroom (shower), kitchen (fridge; storage; bin; washer), dining/office (desk and chair), living/gym (wall and floor; lounge and TV), and parking (bicycle; car)", true],
            ["Resources (3)", [
