      ...
      rows: [
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Travel (3)", [
              ...
              "), and essentials (",
              <WikiLink key="wse" href="https://wise.com/">Wise</WikiLink>,
              "; ",
        ...
        },
        {
          ...
          metrics: [
            ...
            ["Administration (6)", "Identification (Social Security Administration), immigration (USCIS), taxation (IRS), driving (DMV), records (county clerk), and business (secretary of state)", true],
            ["Utilities (4)", "Power (city electric utility), water (city water utility), gas (gas company), and waste (sanitation department) — opened in my name on arrival", true],
            ["Transport (3)", "Local transit (city transit authority), intercity rail (Amtrak), and flights (airport authority)", true],
            ["Institutions (6)", "Health (county hospitals), education (school district), police (city department), fire (fire department), libraries (library district), and mail (USPS)", true],
            ["Outdoor (5)", "Parks, running tracks, trails, pools, and beaches (parks and recreation)", true],
          ],
        },
      ],
    },
