      ...
      rows: [
        {
          ...
          metrics: [
            ...
            ["Spaces (6)", [
              "Bedroom (bed; storage), bathroom (shower), kitchen (fridge; storage; bin; washer), dining/office (",
              <WikiLink key="dsk" href="https://www.flexispot.com/comhar-all-in-one-standing-desk-wooden-top-48-w">desk</WikiLink>,
              " and chair), living/gym (wall and floor; lounge and TV), and parking (bicycle; car)",
            ], true],
            ["Resources (3)", [
              "Belongings (",
              ...
              "; documents; everyday-carry), add-ons (",
              ...
              "; health monitors), and installations (",
