      ...
      <ul className="section-scroll flex snap-x snap-mandatory flex-nowrap gap-1 overflow-x-auto text-sm sm:flex-wrap sm:overflow-visible">
        ...
        <li className="shrink-0 snap-start" style={{ marginLeft: "auto" }}>
          <a
            ...
            className="no-wiki inline-flex min-h-11 items-center whitespace-nowrap rounded border border-rule bg-surface-subtle px-3 py-2 text-text transition-colors hover:border-accent hover:bg-accent hover:text-white sm:min-h-0 sm:px-2.5 sm:py-1"
          >
            Email Lorenzo
          </a>
        </li>
